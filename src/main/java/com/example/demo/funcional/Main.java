...
//si me pide 2 argumentos
		...
		LOG.info("Predicate MetodoReferenciado: "+predicate5.evaluar(20));
		...
		//Metodo Referenciado
		IPersonaFunction<String, Integer> function3 = metodos::aplicarF;
		LOG.info("Function MetodoReferenciado: " + function3.aplicar(23));
		...
		//Metodo Referenciado
		IPersonaUnaryOperator<Integer> unaryMR = metodos::aplicarUO;
		LOG.info("UnaryOperator MetodoReferenciado: " + unaryMR.aplicar(42));
	}
}
